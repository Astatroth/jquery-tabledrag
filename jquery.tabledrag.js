...
// Use the Drupal namespace to facilitate the fork.
   ...
   * 'Drupal.tableDrag.showWeight' in localSorage.
   */
  Drupal.tableDrag.prototype.initColumns = function () {
    ...
    // Set a localStorage item if it is not already present.
    if (localStorage.getItem('Drupal.tableDrag.showWeight') === null) {
      localStorage.setItem('Drupal.tableDrag.showWeight', 0);
      this.hideColumns();
    }
    // Check localStorage item value and show/hide weight columns accordingly.
    else {
      if (localStorage.getItem('Drupal.tableDrag.showWeight') == 1) {
        this.showColumns();
      }
